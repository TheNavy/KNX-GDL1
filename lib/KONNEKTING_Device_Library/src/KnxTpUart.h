...
#define KNX_CONTROL_FIELD_VALID_PATTERN  0b10010000 // 0x90, Only Standard Frame Format "10" is handled
#define KNX_PAYLOAD_LENGTH_MASK          0b00001111 // 0x0F, last 4 bits, only Standard Frame is supported
...
class KnxTpUart {
    ...
    // Pointer to the EVENTS callback function
